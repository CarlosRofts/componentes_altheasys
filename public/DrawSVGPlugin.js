	...
	function w(e) {
		...
		if (
			((i && (x || m)) ||
				...
				'line' === l && ((y = p(e, 'x1')), (w = p(e, 'y1')), (x = Math.abs(x - y)), (m = Math.abs(m - w)))),
			'path' === l)
		)
			(a = u.strokeDasharray),
			...
			for (o = e.getAttribute('points').match(b) || [], 'polygon' === l && o.push(o[0], o[1]), n = 0, f = 2; f < o.length; f += 2)
				...
				return (
					...
					(s = (function _parse(e, t, n) {
						var r,
							...
							s = e.indexOf(' ');
						return (
							(i = s < 0 ? ((r = void 0 !== n ? n + '' : e), e) : ((r = e.substr(0, s)), e.substr(s + 1))),
							(r = o(r, t)),
							(i = o(i, t)) < r ? [i, r] : [r, i]
						);
					})(r, f, (i = x(e, f))[0])),
			...
			render: function render(e, t) {
				...
				if (o) {
					...
					(i = t._dash || (e && 1 !== e && 1e-4) || 0),
						(n = t._length - i + 0.1),
						(s = t._offset),
						i && s && i + Math.abs(s % t._length) > t._length - 0.2 && (s += s < 0 ? 0.1 : -0.1) && (n += 0.1),
